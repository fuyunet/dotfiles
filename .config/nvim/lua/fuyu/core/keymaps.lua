...
keymap.set("i", "jk", "<ESC>", { desc = "Exit insert mode with jk" }) -- I am not sure about this one.
...
keymap.set("n", "<leader>se", "<C-w>=", { desc = "Make splits equal size" }) --make spit equal window size
